...
console.log(Programmer.compareSkill(dev1, dev2));
...
class GroceryItem {
  ...
  static compareQuantities(item1, item2) {
    if (item1.quantity > item2.quantity) {
      ...
      console.log(`${item1.name} and ${item2.name} has same quantity.`);
    }
  }
}

const apple = new GroceryItem("Apple", 6);
const banana = new GroceryItem("Banana", 6);
GroceryItem.compareQuantities(apple, banana);
